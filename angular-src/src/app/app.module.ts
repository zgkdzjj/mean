...
const appRoutes: Routes = [
  ...
  {path: 'order/add', component: OrderComponent, canActivate: [AuthGuardService]},
  {path: 'order/manageorder', component: ManageorderComponent, canActivate: [AuthGuardService]}
